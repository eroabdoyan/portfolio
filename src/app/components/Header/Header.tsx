...
const Header: React.FC = () => {
  ...
  return (
    <header className={`text-white flex  p-6   ${isMenuOpen ? 'max-sm:pb-32' : ''} mx-auto max-w-screen-xl`}>
      ...
      <ul className={`sm:absolute sm:right-0 sm:mr-5 sm:top-20 xl:flex xl:space-x-10 text-lg font-mono ${isMenuOpen ? 'block' : 'hidden'} md:block`}>
        <li className='mt-2 md:mt-0'>
          <Link href='#about' onClick={() => { scrollToSection('about', 800); setIsMenuOpen(false); }}>About</Link>
        </li>
        <li className='mt-2 md:mt-0'>
          <Link href='#skills' onClick={() => { scrollToSection('skills', 800); setIsMenuOpen(false); }}>Skills</Link>
        </li>  
        <li className='mt-2 md:mt-0'>
          <Link href='#projects' onClick={() => { scrollToSection('projects', 800); setIsMenuOpen(false); }}>Projects</Link>
        </li> 
        <li className='mt-2 md:mt-0'>
          <Link href='#contact' onClick={() => { scrollToSection('contact', 800); setIsMenuOpen(false); }}>Contact</Link>
        </li> 
      </ul>      
    </header>
  )
